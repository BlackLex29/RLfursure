...
import { collection, getDocs, addDoc, onSnapshot, deleteDoc, doc, updateDoc, setDoc, query, getDoc } from "firebase/firestore";
// Global Styles
...
const Admindashboard: React.FC = () => {
  ...
  const [viewMode, setViewMode] = useState<"dashboard" | "today" | "all" | "unavailable" | "settings" | "refunds">("dashboard");
  ...
  const handleEnable2FA = async () => {
    ...
    try {
      console.log("🔒 Enabling 2FA for email:", otpEmail);
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      ...
      console.log("✅ Verifying OTP for user:", currentUser.email);
      await new Promise(resolve => setTimeout(resolve, 1000));
      ...
      if (updatedDoc.exists()) {
        ...
        console.log("✅ Firestore confirmation - 2FA enabled:", final2FAStatus);
        setTwoFactorEnabled(final2FAStatus);
        localStorage.setItem('twoFactorEnabled', final2FAStatus.toString());
      }
              ...
              {!otpSent ? (
                ...
                <OTPVerificationSection>
                  <OTPInstructions>
                    ...
                    Please enter it below to enable 2FA.
                  </OTPInstructions>
                          ...
                          <AppointmentCard key={appointment.id} $delay={index * 0.1} $borderLeftColor={borderColor}>
                            ...
                            <AppointmentDetails>
                              ...
                              <DetailRow>
                                ...
                                <DetailValue>
                                  {appointment.completedAt ? formatDateTime(appointment.completedAt) : "Recently"}
                                </DetailValue>
                              </DetailRow>
                            </AppointmentDetails>
                            <AppointmentActions>
