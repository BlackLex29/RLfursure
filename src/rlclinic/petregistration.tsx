      ...
      const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
          ...
          // ✅ CRITICAL: Use EXACTLY the same field names as in Firestore rules
          const petData = {
            petId: petId,
            ...
            gender: gender,
            // ✅ MUST HAVE BOTH FIELDS for Firestore rules to work
          ...
          setModalMessage("Pet registered successfully!");
          setShowSuccessModal(true);
          
        } catch (error) {
          console.error("❌ Error saving pet:", error);
          setModalMessage(`Failed to save pet: ${error instanceof Error ? error.message : 'Unknown error'}`);
          setShowErrorModal(true);
        } finally {
          setIsLoading(false);
        }
